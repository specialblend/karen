...
**Estimated Story Points:** ${estimate.storyPoints} (**Confidence:** ${estimate.normalizedConfidence}%)

Generated by [KAREN](https://github.com/specialblend/karen) using \`${review.model}/${estimate.model}\`
`;
}
